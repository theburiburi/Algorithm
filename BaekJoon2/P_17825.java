...
public class P_17825 { //ë°±íŠ¸?˜í‚¹ ê°™ì? ?ìˆ˜ê°€ ?ˆì–´???˜ì •?„ìš”?œë° ?¨ìˆœ ?‘ì—…?´ë¼ ????
    ...
    static void backtrack(int count) {
        ...
        for (int i = 1; i <= 4; i++) {
            if (horse[i].nowPosition == -2) continue; // ?´ë? ?„ì°©??ë§ì? ?¤í‚µ
